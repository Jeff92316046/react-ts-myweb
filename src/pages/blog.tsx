                ...
                return(
                    <Card sx={{m:4}} key={index}>
                        <CardContent >
                            ...
                            <Typography sx={{ m:{ xs:1,sm:2 },mx:{ xs:2,sm:3 } }} variant={"body1"} >
                                Assignees :&nbsp;
                                <Typography sx={{color:theme.palette.text.primary}} component="a" href={i['assignee']['html_url']} variant={"body1"} >
                                    {i['assignee']['login']}
                                </Typography>
                            </Typography>
                            <Typography sx={{ m:{ xs:1,sm:2 },mx:{ xs:2,sm:3 } }} variant={"body1"} >
                                label :&nbsp;
                                <Typography sx={{color:i['labels'][0]['colors']}} component="span" variant={"body1"} >
                                    {i['labels'][0]['name']}
                                </Typography>
                            </Typography>
                            <Typography sx={{ m:{ xs:1,sm:2 },mx:{ xs:2,sm:3 } }} variant={"body1"} >
